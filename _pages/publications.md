...
<div class="publication-block">
    ...
    <img src="/images/deployment-centric-AI.png" alt="deployment-centric-AI" class="publication-image" onclick="expandImage(this, '/images/deployment-centric-AI.png')"></a>
        ...
        <p class="author-name">Xianyuan Liu, Jiayang Zhang, Shuo Zhou,..., <strong>Chen Chen</strong>, Valentin Danchev, Nataliya Tkachenko, Lei Lu, Tingting Zhu, Gregory G. Slabaugh, Roger K. Moore, William K. Cheung, Peter H. Charlton & Haiping Lu</p>
        <div class="links">
...
<div class="publication-block">
    ...
    <img src="/images/CLAIM.jpeg" alt="CLAIM" class="publication-image" onclick="expandImage(this, '/images/ViTa.jpeg')"></a>
        </p>
        <h3 class="conference-name">AIiH 2025 <strong>Best Paper</strong></h3>   
